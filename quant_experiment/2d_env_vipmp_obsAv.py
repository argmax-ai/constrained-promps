# 2-D environment with randomly placed obstacles to avoid
...
from opt_pmp_utils.constraints import Repeller
...
def main():
    ...
    nt = 101  # Number of points in the timegrid
    ...
    n_obstacles = [1, 2, 3]  # Number of obstacles, can be list of ints or int
    ...
    rep_margin_min = 0.3  # Minimum radius of the obstacle
    rep_margin_max = 0.6  # Maximum radius of the obstacle
    # VIPMP Parameter
    ...
    ##################
    experiment_folder = f"output/experiments_obsAv/"

    for i in range(len(n_obstacles) if isinstance(n_obstacles, Container) else 1):
        for ii in range(n_experiments):
            ...
            env = TrajectoryEnv(
                ...
                if isinstance(n_obstacles, Container)
                else n_obstacles,
                n_via_points=n_via_points,
                rep_margin_min=rep_margin_min,
                rep_margin_max=rep_margin_max,
